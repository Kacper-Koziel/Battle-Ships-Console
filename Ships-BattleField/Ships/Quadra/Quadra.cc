...
Quadra::Quadra(const HANDLE &screenHandle, const Point2D &start, const Point2D &end, int blocksLeft)
{
...
void Quadra::drawGhostN(const HANDLE &screenHandle, const Point2D &start, const Point2D &end, short color)
{
...
void Quadra::drawGhostE(const HANDLE &screenHandle, const Point2D &start, const Point2D &end, short color)
{
    Console::staticSetFontColor(screenHandle, color);
...
void Quadra::drawGhostS(const HANDLE &screenHandle, const Point2D &start, const Point2D &end, short color)
{
    Console::staticSetFontColor(screenHandle, color);
...
void Quadra::drawGhostW(const HANDLE &screenHandle, const Point2D &start, const Point2D &end, short color)
{
    Console::staticSetFontColor(screenHandle, color);
